...
```bash
$ python main.py --tracking-method strongsort
                                    ocsort
                                    bytetrack
```
...
$ python main.py --source 0 --yolo-weights yolov5n.pt --img 640
                                            yolov5s.tflite
                                            yolov5m.pt
                                            yolov5l.onnx 
                                            yolov5x.pt --img 1280
...
$ python main.py --source 0 --reid-weights osnet_x0_25_market1501.pt
...
```bash
python main.py --source 0 --yolo-weights yolov5/weights/crowdhuman_yolov5m.pt --classes 0  # tracks persons, only
```

If you want to track a subset of the MS COCO classes, add their corresponding index after the classes flag

```bash
python main.py --source 0 --yolo-weights yolov5s.pt --classes 16 17  # tracks cats and dogs, only
```
...
```bash
python main.py --source ... --save-txt
```
